...
class WheatherPatternMining:
    def __init__(self, imput_file='../data/weather_aizuwakamatsu_2024_01.csv'):
        self.inputFile = imput_file
    ...
    def preprocess_and_pattern_miming(self):
        ...
        obj = stats.TransactionalDatabase(self.inputFile,sep=',')
